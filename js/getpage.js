...
export let routes = {
    ...
    'order':'<div id="container">' +
        ...
        '           <label for="surname" required>Enter your surname</label><br>' +
        ...
        '                <option value="Khmelnytskyi" selected > Khmelnytskyi </option></select><br>' +
        ...
        '           <input type="datetime-local" id="deldate"><br><label>Enter way to pay</label><br><br>' +
        '           <label for="paycard">    Now</label><br>' +
        '           <input type="radio" name="pay" id="paycard"  checked style="margin: initial;font:initial;font-size: 1.4em;width: initial;"><br>' +
        '           <label for="paycash">    On delivery</label><br>' +
